...
description: Full Radiant component reference with props, code examples, and patterns. Load when checking if a component exists, needing props/examples, or building with Radiant components.
globs:
